...
use routes::{
    AGENTIC_ROUTE, ARCHITECTURE_ROUTE, BACKENDS_ROUTE, CLI_ROUTE, CODE_SPLITTING_ROUTE,
    ...
    CROSS_PLATFORM_ROUTE, DEMO_ROUTE, EXTENSIBILITY_ROUTE, FEATURES_ROUTE, FURTHER_READING_ROUTE,
    HOME_ROUTE, IDEA_UI_ROUTE, INSTALL_ROUTE, NAVIGATION_ROUTE, PERFORMANCE_ROUTE,
    PRIMITIVES_ROUTE, QUICKSTART_ROUTE, REACTIVITY_ROUTE, ROADMAP_ROUTE, SERVER_FUNCTIONS_ROUTE,
    SSR_ROUTE, STYLING_ROUTE, TARGETS_ROUTE, TYPE_SAFETY_ROUTE, WHY_RUST_ROUTE,
};
...
pub fn app() -> Element {
    ...
    let builder = SwapNavigator::new(&HOME_ROUTE)
        ...
        .screen(EXTENSIBILITY_ROUTE, move |_| titled(&EXTENSIBILITY_ROUTE, pages::extensibility::page()))
        .screen(CLI_ROUTE, move |_| titled(&CLI_ROUTE, pages::cli::page()))
        .screen(IDEA_UI_ROUTE, move |_| titled(&IDEA_UI_ROUTE, pages::idea_ui::page()))
