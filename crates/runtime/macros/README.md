...
This crate sits between application code and `runtime-core`. It takes the
...
`runtime-core`'s primitive constructors.
...
3. With `runtime-core/hot-reload`, wraps the body through
...
the consumer hands it via `runtime_core::install_theme(...)`.
