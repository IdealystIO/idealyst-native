...
//! fine within a single walk, but **breaks across rebuilds** in runtime-server
...
///     runtime_core::style_path_hash(module_path!(), "Variant");
/// ```
///
...
///
/// ```ignore
/// let k = runtime_core::hash_key(&item.id);
