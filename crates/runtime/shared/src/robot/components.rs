...
pub fn set_pending_component_link(instance: ComponentInstanceId) {
...
pub fn take_pending_component_link() -> Option<ComponentInstanceId> {
    PENDING_LINK.with(|p| p.take())
}

/// Record that component `instance` renders as element `element`.
pub fn link_component_element(instance: ComponentInstanceId, element: super::ElementId) {
