...
//! into `runtime_shared::robot::logs` via `push("stdout"/"stderr",
...
//! runtime_shared::robot::logs::start_stdio_capture();
//! ```
//!
...
/// Register the POSIX `LogCapture` impl with `runtime-shared`. First
