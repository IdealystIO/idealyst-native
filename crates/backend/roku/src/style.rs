...
fn flex_direction(d: runtime_shared::FlexDirection) -> WireFlexDirection {
    match d {
        runtime_shared::FlexDirection::Row => WireFlexDirection::Row,
        runtime_shared::FlexDirection::Column => WireFlexDirection::Column,
        runtime_shared::FlexDirection::RowReverse => WireFlexDirection::RowReverse,
        runtime_shared::FlexDirection::ColumnReverse => WireFlexDirection::ColumnReverse,
    }
}

fn justify_content(j: runtime_shared::JustifyContent) -> WireJustifyContent {
...
fn align_items(a: runtime_shared::AlignItems) -> WireAlignItems {
...
fn text_align(t: runtime_shared::TextAlign) -> WireTextAlign {
