...
//! - **Platform-agnostic.** Built for the runtime-server dylib host today, but
...
/// here so stale [`HotFnPanic`]s from nested `dev_hot::call`
...
/// rebuild of the patch dylib, the runtime-server host calls
