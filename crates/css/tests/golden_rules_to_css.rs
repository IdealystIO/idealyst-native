...
fn maximal_rules() -> StyleRules {
    StyleRules {
        ...
        grid_row: Some(runtime_shared::GridPlacement::Line(3)),
        grid_column: Some(runtime_shared::GridPlacement::Lines(1, -1)),
        ...
        scrollbar: Some(runtime_shared::ScrollbarVisibility::Hidden),
