...
//! - **AAS / wire**: bytes ship over the wire on first reference and
...
/// use framework_core::style::{FontStyle, FontWeight};
///
/// static INTER: framework_core::assets::Typeface = typeface! {
///     name: "Inter",
///     faces: [
