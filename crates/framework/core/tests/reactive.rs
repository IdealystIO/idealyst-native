...
//!
//! ```bash
//! cargo test -p framework-core --test reactive                  # everything in this suite
//! cargo test -p framework-core --test reactive smoke::          # just smoke checks
//! cargo test -p framework-core --test reactive topology::diamond  # one test
//! ```
//!
