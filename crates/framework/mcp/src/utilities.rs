...
inventory::submit! {
    UtilityEntry {
        name: "parse_color",
        module_path: "framework_core::color",
        docs: "Parse a CSS-ish color string (`#abc`, `#aabbcc`, `#aabbccdd`, `rgb(r,g,b)`, `rgba(r,g,b,a)`, named colors) into the canonical `Rgba` byte intermediate. Centralized in framework-core; backends use 1-line shims.",
        params: &[
            ParamSpec {
                name: "input",
                type_str: "& str",
...
inventory::submit! {
    UtilityEntry {
        name: "now_micros",
        module_path: "framework_core::time",
...
inventory::submit! {
    UtilityEntry {
        name: "active_theme",
        module_path: "framework_core::theme",
...
inventory::submit! {
    UtilityEntry {
        ...
        module_path: "framework_core::layout",
