        ...
        match cmd {
            ...
            Command::CreateOverlay {
                ...
                let resolved_backdrop = match backdrop {
                    idealyst_wire::WireBackdropMode::None => BackdropMode::None,
                    idealyst_wire::WireBackdropMode::Dismiss => BackdropMode::Dismiss,
                    idealyst_wire::WireBackdropMode::Capture => BackdropMode::Opaque,
                };
