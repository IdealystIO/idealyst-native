...
// <meta-data> (plus an optional `IdealystRuntimeServerUrl` URL override for
...
// parent ViewGroup to the Rust runtime-server shell, and runs a Handler tick
// loop calling drainRuntimeServer() on the UI thread.
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (url != null && !url.isEmpty()) {
            ...
            NativeBridge.attachRuntimeServer(this, root, readAppIdFromManifest());
        }
