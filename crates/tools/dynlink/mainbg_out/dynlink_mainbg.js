/* @ts-self-types="./dynlink_mainbg.d.ts" */
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_e9057e1abba1a344: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dynlink_mainbg_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
